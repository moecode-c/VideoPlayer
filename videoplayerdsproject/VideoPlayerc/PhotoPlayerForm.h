...
namespace VideoPlayerc {
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->btnPrevious->Size = System::Drawing::Size(36, 36);
            ...
            this->btnNext->Location = System::Drawing::Point(64, 15);
            this->btnNext->Name = L"btnNext";
            this->btnNext->Size = System::Drawing::Size(36, 36);
            ...
            this->btnZoomIn->Location = System::Drawing::Point(110, 15);
            this->btnZoomIn->Name = L"btnZoomIn";
            this->btnZoomIn->Size = System::Drawing::Size(36, 36);
            ...
            this->btnZoomOut->Location = System::Drawing::Point(154, 15);
            this->btnZoomOut->Name = L"btnZoomOut";
            this->btnZoomOut->Size = System::Drawing::Size(36, 36);
            ...
            this->btnZoomReset->Location = System::Drawing::Point(198, 15);
            this->btnZoomReset->Name = L"btnZoomReset";
            this->btnZoomReset->Size = System::Drawing::Size(36, 36);
            ...
            this->btnRotateLeft->Location = System::Drawing::Point(242, 15);
            this->btnRotateLeft->Name = L"btnRotateLeft";
            this->btnRotateLeft->Size = System::Drawing::Size(36, 36);
            ...
            this->btnRotateRight->Location = System::Drawing::Point(286, 15);
            this->btnRotateRight->Name = L"btnRotateRight";
            this->btnRotateRight->Size = System::Drawing::Size(36, 36);
            ...
            this->btnSlideshow->Location = System::Drawing::Point(330, 15);
            this->btnSlideshow->Name = L"btnSlideshow";
            this->btnSlideshow->Size = System::Drawing::Size(36, 36);
            ...
            this->btnSpeed->Location = System::Drawing::Point(374, 15);
            this->btnSpeed->Name = L"btnSpeed";
            this->btnSpeed->Size = System::Drawing::Size(36, 36);
            ...
            this->btnShuffle->Location = System::Drawing::Point(418, 15);
            this->btnShuffle->Name = L"btnShuffle";
            this->btnShuffle->Size = System::Drawing::Size(36, 36);
            ...
            this->trackBarZoom->Location = System::Drawing::Point(470, 65);
            this->trackBarZoom->Maximum = 400;
            this->trackBarZoom->Minimum = 10;
            this->trackBarZoom->Name = L"trackBarZoom";
            this->trackBarZoom->Size = System::Drawing::Size(260, 45);
            ...
            this->lblZoom->Location = System::Drawing::Point(330, 70);
            ...
            // replace text buttons with image buttons where possible using startup path
            try {
                String^ base = System::IO::Path::Combine(Application::StartupPath, "Images");
                // helper lambda not used — expand explicit checks
                String^ p;

                p = System::IO::Path::Combine(base, "next.png");
                if (File::Exists(p)) { this->btnNext->BackgroundImage = Image::FromFile(p); this->btnNext->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "previous.png");
                if (File::Exists(p)) { this->btnPrevious->BackgroundImage = Image::FromFile(p); this->btnPrevious->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "zoominbtn.png");
                if (File::Exists(p)) { this->btnZoomIn->BackgroundImage = Image::FromFile(p); this->btnZoomIn->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "zoomoutbtn.png");
                if (File::Exists(p)) { this->btnZoomOut->BackgroundImage = Image::FromFile(p); this->btnZoomOut->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "rotate.png");
                if (File::Exists(p)) { this->btnRotateLeft->BackgroundImage = Image::FromFile(p); this->btnRotateLeft->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "rotate2.png");
                if (File::Exists(p)) { this->btnRotateRight->BackgroundImage = Image::FromFile(p); this->btnRotateRight->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "upload.png");
                if (File::Exists(p)) { this->btnAddPhotos->BackgroundImage = Image::FromFile(p); this->btnAddPhotos->BackgroundImageLayout = ImageLayout::Zoom; this->btnAddPhotos->Size = System::Drawing::Size(36,36); }

                p = System::IO::Path::Combine(base, "deletebtn.png");
                if (File::Exists(p)) { this->btnRemove->BackgroundImage = Image::FromFile(p); this->btnRemove->BackgroundImageLayout = ImageLayout::Zoom; this->btnRemove->Size = System::Drawing::Size(36,36); }

                p = System::IO::Path::Combine(base, "play.png");
                if (File::Exists(p)) { this->btnSlideshow->BackgroundImage = Image::FromFile(p); this->btnSlideshow->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "speed.png");
                if (File::Exists(p)) { this->btnSpeed->BackgroundImage = Image::FromFile(p); this->btnSpeed->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "search.png");
                if (File::Exists(p)) { this->btnSearch->BackgroundImage = Image::FromFile(p); this->btnSearch->BackgroundImageLayout = ImageLayout::Zoom; }

                p = System::IO::Path::Combine(base, "sort.png");
                if (File::Exists(p)) { this->btnSortAZ->BackgroundImage = Image::FromFile(p); this->btnSortAZ->BackgroundImageLayout = ImageLayout::Zoom; this->btnSortAZ->Size = System::Drawing::Size(36,36); }

                // apply icon-only visual rules to every button that got an icon
                array<Button^>^ imgButtons = gcnew array<Button^>(12) {
                    this->btnNext, this->btnPrevious, this->btnZoomIn, this->btnZoomOut,
                ...
                for each (Button^ b in imgButtons) {
                    ...
                    b->Text = L"";
                    // set BackColor to panel background so button chrome blends in
                    b->BackColor = System::Drawing::Color::FromArgb(40,40,50);
            ...
            this->btnRemove->Size = System::Drawing::Size(36, 36);
            ...
            this->btnSortAZ->Size = System::Drawing::Size(36, 36);
            ...
            this->btnSortTime->Location = System::Drawing::Point(64, 695);
