...
namespace VideoPlayerc {
    ...
    public:
        PhotoPlayerForm(void)
        {
            ...
            this->imagesBasePath = L"C:\\Users\\samag\\Documents\\VideoPlayer - Copy\\videoplayerdsproject - Copy\\x64\\Images\\";
            this->slideshowRunning = false;
            this->slideshowTimer->Tick += gcnew System::EventHandler(this, &PhotoPlayerForm::OnSlideshowTick);
        }
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            try {
                ...
                // Convert any BackgroundImage into Button->Image for reliable display
                for each (Button ^ b in imgButtons) {
                    if (b == nullptr) continue;
                    if (b->BackgroundImage != nullptr) {
                ...
                void OnSlideshowTick(System::Object ^ sender, System::EventArgs ^ e);
